<article class="HabitacionForm row white z-depth-1 u-none"
        style="z-index: 111111;left:30% !important">
  ...
  <article class="HabitacionForm-gastos u-none">
    ...
    <div class="input-field col-s5" style="margin-left: 1em !important;">
  ...
  <div class="flex space" style="margin-bottom:1em !important">
    <button class="btn waves-effect waves-light red darken-3 cancelar-form">Cancelar</button>
    <button class="btn waves-effect waves-light color-toolbar aceptar-form">Aceptar</button>
  </div>
</article>
