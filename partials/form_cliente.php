<div class="row">
  ...
  <form class="col s12 z-depth-1 white">
    ...
    <div class="input-field col s12 m6">
      ...
      <input id="password-cliente" type="password" class="validate" maxlength="140" length="140">
      <label for="password-cliente" class="field-label">Contraseña Ejemplo: maria1234 *</label>
    </div>
