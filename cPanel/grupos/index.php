    ...
    <div class="form-cliente row white z-depth-1">
      ...
      <div class="col-12">
        ...
        <div class="input-field col s6">
          ...
          <label class="label-fecha" for="dias--quedar">Dias de hospedaje</label>
        </div>
        <div class="col s12">
...
<script type="text/javascript" src="grupos/static/grupos.js"></script>
<script type="text/javascript" src="grupos/static/index.js"></script>
