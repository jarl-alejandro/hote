...
function validarFormulario() {
  ...
  if($cargo.val() === null) {
    $cargo.focus()
    toast("Porfavor ingrese su cargo")
    return false
  }
  else flag = true
  return flag
  ...
  function onGuardar (e) {
    ...
    if (validarFormulario()) {
      $.ajax({
        type:"POST",
        url:"empleados/servicio/guardar.php",
        data: getData()
      })
      .done(function (data) {
        console.log(data)
  ...
  function reporteGeneral() {
    window.open (`./empleados/reporte/lista.php`, "_blank","toolbar=yes, scrollbars=yes, resizable=yes, top=50, left=60, width=1200, height=600")
  }
