      ...
      Traslado por fecha
		...
		<div class="row">
			<div class="input-field col s6">
				...
				<label for="desde" class="desde_label">Inicio de traslado</label>
			</div>
			<div class="input-field col s6">
				<input type="date" class="datepicker" id="hasta" min="<?= $hoy ?>">
				<label for="hasta" class="hasta_label">Fin de traslado</label>
			</div>
		</div>
	...
	<ul>
		...
		<li>
			<a class="btn-floating red darken-1 tooltipped" data-position="left"
				data-delay="50" data-tooltip="traslado por fecha" id="reportByDate">
				<i class="material-icons">access_alarms</i>
			</a>
		</li>
		<li>
			<a class="btn-floating indigo darken-1 tooltipped" data-position="left"
				data-delay="50" data-tooltip="Reporte de traslado por fecha" id="byReport">
...
<script>
	$.getScript("traslado-fecha/static/js/componente.js")
</script>
