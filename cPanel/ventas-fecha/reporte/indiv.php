...
$pdf->Cell(190, 6.5, utf8_decode("Cliente: " . $venta["cliente"]), 0, 'C');
$pdf->Cell(190, 6.5, utf8_decode("Cedula: " . $venta["cliente_restaurante"]), 0, 'C');
$pdf->Ln();

$pdf->Cell(190, 6.5, utf8_decode("Direccion: " . $venta["direccion_cliente"]), 0, 'C');
