      ...
      compras por fecha
		...
		<div class="row">
			<div class="input-field col s6">
				...
				<label for="desde" class="desde_label">Inicio de compras</label>
			</div>
			<div class="input-field col s6">
	...
	<ul>
		...
		<li>
			<a class="btn-floating red darken-1 tooltipped" data-position="left"
				data-delay="50" data-tooltip="Compras por fecha" id="reportByDate">
...
<script>
	$.getScript("compras-fecha/static/js/componente.js")
</script>
