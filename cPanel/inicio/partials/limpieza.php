<article class="col s4 Reservas-active LimpiezaMap">
  <div class="card activo-card sticky-action card_<?= $row["codigo_habitacion"]?> blue white-text darken-4">
    ...
    <div class="card-reveal">
      ...
      <div class="flex space">
        ...
        data-valor="<?= $row["valor_habitacion"] ?>" data-cant="<?= $row["cant_habitacion"] ?>" disabled>ALQUILAR</button>
      </div>
    </div>
