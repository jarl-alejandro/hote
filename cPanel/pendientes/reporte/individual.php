...
class PDF extends FPDF {
  ...
  function Header() {
    ...
    $this->Text(110, 54, 'REPORTE DE CLIENTE PENDIENTE');
    $this->Ln(25);
...
$cedula = $_GET["cedula"];
// $query = $pdo->query("SELECT * FROM hotel_cliente WHERE cedula_cliente='$cedula'");
$query = $pdo->query("SELECT * FROM vista_reservacion WHERE cedula_cliente='$cedula'");
