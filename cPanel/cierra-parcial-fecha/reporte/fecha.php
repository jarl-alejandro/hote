...
$factura = $pdo->query("SELECT * FROM hotel_facturam WHERE factura_estado='pagado' AND  
                            fecha_facturam='$fecha'");

$restaurante = $pdo->query("SELECT * FROM hotel_restaurante WHERE 
                              fecha_restaurante='$fecha'");

$egresos = $pdo->query("SELECT * FROM hotel_egreso WHERE fecha_egreso='$fecha'");

$mensuales = $pdo->query("SELECT * FROM v_pagos_mensuales WHERE mensual_fecha='$fecha'");
