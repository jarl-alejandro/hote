<div class="row">
  ...
  <form class="col s12 z-depth-1 white">
    ...
    <div class="input-field col s12 m6">
      ...
      <label for="nombre" class="field-label">Nombre Ejemplo: Matias</label>
    </div>
    ...
    <div class="input-field col s12 m6">
      ...
      <label for="email" class="field-label" data-error="E-mail incorrecto" data-success="E-mail correcto">Email Ejemplo: matias@gmail.com</label>
    </div>

    <div class="input-field col s12 m6">
      <i class="material-icons prefix">phone</i>
      <input id="telefono" type="tel" class="validate" maxlength="10" length="10" onkeypress="ValidaSoloNumeros()">
      <label for="telefono" class="field-label">Telefono (Opcional) Ejemplo: 023766782</label>
    </div>
    ...
    <div class="input-field col s12 m6">
      ...
      <label for="celular" class="field-label">Celular Ejemplo: 0599373628</label>
    </div>

    <div class="input-field col s12 m6">
      <i class="material-icons prefix">my_location</i>
      <input id="direccion" type="tel" class="validate" maxlength="140" length="140">
      <label for="direccion" class="field-label">Direccion Ejemplo: Luz de America</label>
    </div>
