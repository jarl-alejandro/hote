...
if($id != "") {
  ...
  $new = $pdo->query("INSERT INTO hotel_cliente (cedula_cliente, nombre_cliente, apellido_cliente, email_cliente, telefono_cliente, celular_cliente, direccion_cliente, password_cliente, estado_cliente)
    VALUES ('$cedula', '$nombre', '$apellido', '$email', '$telefono', '$celular', '$direccion', '$password', '1')");
