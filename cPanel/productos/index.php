...
<div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
  ...
  <ul>
    ...
    <li><a class="btn-floating blue tooltipped" id="nuevo" data-position="left" data-delay="50" data-tooltip="Nuevo Producto/Servicio"><i class="material-icons">mode_edit</i></a></li>
  </ul>
</div>
<?php include 'partials/alerta.php'; ?>
<script>
  $.getScript("productos/static/js/componente.js")
</script>
