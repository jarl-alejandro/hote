...
class PDF extends FPDF {
  ...
  function Header() {
    ...
    $this->Text(110, 54, 'LISTADO DE PRODUCTOS Y SERVICIOS');
    $this->Ln(25);
...
$pdf -> SetY(65);
// $header = array('CODIGO', 'NOMBRE DEL PRODUCTO/SERVICIO', 'VALOR', 'TIPO');
...
$query = $pdo->query("SELECT * FROM hotel_producto");
