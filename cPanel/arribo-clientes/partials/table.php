...
<table class=" highlight responsive-table bordered z-depth-1 centered" id="Tab_Filter">
 ...
 <tbody class="white">
   ...
   $clientes = $pdo->query("SELECT * FROM vista_huespedes WHERE fecha_habitacion='$fecha_actual'");
   if($clientes->rowCount() == 0){
    echo "<tr>
      <td colspan='5'>No hay clientes para arribar</td>
    </tr>";
   }
   if ($hora > $hora_actual) {
     echo "<tr>
...
<script>
  $.getScript("arribo-clientes/static/js/actions.js")
