    ...
    <?php }
      foreach ($habitaciones as $habitacion):?>
        <li class="Habitacion-item flex space">
          ...
          <button class="btn-floating btn color-acent waves-effect waves-light btn-habitacion"
            style="margin-bottom:3px" data-nombre="<?= $habitacion["nombre_habitacion"] ?>"
            data-cant="<?= $habitacion["cant_detalle"] ?>" data-cliente="<?= $habitacion["cliente"] ?>"
