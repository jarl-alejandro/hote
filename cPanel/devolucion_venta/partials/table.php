 ...
 <tbody class="white">
  ...
  ?>
   <tr>
     ...
     <td>
       <button class="btn waves-effect waves-light blue darken-4 factura-see" data-codigo="<?= $row["codigo_venta"] ?>"><i class="material-icons">edit</i></button>
       <button class="btn waves-effect waves-light orange darken-4 reporte-table" data-codigo="<?= $row["codigo_venta"] ?>"><i class="material-icons">polymer</i></button>
     </td>
   </tr>
 <?php endforeach ?>
</tbody>
...
<script>
  $.getScript("devolucion_venta/static/js/actions.js")
