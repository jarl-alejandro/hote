...
$venta = array("detalle"=>$v["detalle_venta"], "fecha"=>$v["fecha_venta"], "total"=>$v["total_venta"], 
  "habitacion"=>$v["nombre_habitacion"], "codigo"=>$v["codigo_venta"]);
...
foreach ($r_detail as $detail) {
  ...
  $detalle[] = array('id'=>$id, 'codigo'=>$codigo, 'cant'=>$cant, 'producto'=>$producto, 'unit'=>$unit, 'total'=>$total);
}
